                    ...
                    <div class="panel-body">
                        <form action="login" method="post" role="form" class="login-form" id="loginform">
                            <fieldset>
                                ...
                                <br><br>                              
                                <div class="col-lg-12">
                                	    <a href="vehicle.jsp" class="btn btn-lg btn-primary col-lg-6">Login <i class="fa fa-sign-in"></i></a>                              	
                                	<!--<button type="submit" class="btn btn-lg btn-primary col-lg-6">Login <i class="fa fa-sign-in"></i></button>-->
                                	<a href="signup.jsp" class="btn btn-lg btn-success col-lg-6">Sign Up <i class="fa fa-user-plus"></i></a>
                                </div>
                            </fieldset>
                        </form>
                    </div>
